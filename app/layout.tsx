...
export const metadata: Metadata = {
	title: 'Ahmed Abu Seada - Backend Developer',
	description:
	...
	authors: [{ name: 'Ahmed Abu Seada' }],
	creator: 'Ahmed Abu Seada',
	openGraph: {
		title: 'Ahmed Abu Seada - Backend Developer Portfolio',
		...
		siteName: 'Ahmed Abu Seada - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Ahmed Abu Seada - Backend Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
